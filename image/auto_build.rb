...
images = {
  base_slim: { name: 'base', tag: "kitabisa/discourse-base:build_slim", squash: true, extra_args: '-f slim.Dockerfile' },
  base: { name: 'base', tag: "kitabisa/discourse-base:build", extra_args: '-f release.Dockerfile' },
}
